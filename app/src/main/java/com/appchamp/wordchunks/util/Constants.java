...
public class Constants {
    ...
    public static final String REALM_FIELD_NAME_ID = "id";
    public static final String REALM_FIELD_NAME_LEVEL_ID = "levelId";
    public static final String REALM_FIELD_NAME_POSITION_IN_GRID = "positionInGrid";
    public static final String REALM_FIELD_NAME_STATE = "state";
