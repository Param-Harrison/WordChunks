...
class WordsHintAdapter(private val words: List<Word>, private val packColor: Int) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.bind(words[position], packColor)
    }
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(word: Word, packColor: Int) = with(itemView) {
