...
public class LevelAlreadyCompletedFrag extends Fragment {

    private OnBackToLevelsListener callback;

    public LevelAlreadyCompletedFrag() {
        // Requires empty public constructor
    }

    public static LevelAlreadyCompletedFrag newInstance() {
        return new LevelAlreadyCompletedFrag();
    }
