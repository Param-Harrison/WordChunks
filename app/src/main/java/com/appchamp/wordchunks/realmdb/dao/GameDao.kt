...
//    /**
//     * Creates the list of Realm Pack objects using the PackGson list.
//     *
//     * @param packJsonList the list of PackGson objects.
//     */
//    fun loadPacks(packJsonList: List<PackGson>) {
...
//
//                it.loadLevels(pack, packPojo.levels)
//
//                packs.add(pack)
//            }
//        }
...
//
//    /**
//     * Creates the list of Realm Level objects using the LevelGson objects.
//     *
//     * @param pack          the pack object that will be used to create levels into it.
//     * @param levelJsonList the list of LevelGson objects.
//     */
//    private fun Realm.loadLevels(pack: Pack, levelJsonList: List<LevelGson>) {
...
//
//            level.words = loadWords(wordsSplit, level.id)
//
//            level.chunks = loadChunks(wordsSplit, level.words, level.id)
//
//            levels.add(level)
//            pack.levels = levels
//        }
...
//     */
//    private fun Realm.loadWords(wordsSplit: List<String>, levelId: String): RealmList<Word> {
...
//     */
//    private fun Realm.loadChunks(wordsSplit: List<String>, wordsRealm: RealmList<Word>,
...
//        realm.executeTransaction { it.createObject(GameProcess::class.java) }
//
//    }
//
//    fun findGame(): GameProcess {
//        return realm.where(GameProcess::class.java).findFirst()
//    }
//
//    fun setShowTutorial(game: GameProcess, value: Boolean) {
//        realm.executeTransaction {
